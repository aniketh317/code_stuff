...
A flow statisying the constraints (iff) max flow in the new network is equal to the total capacity of edges out of source and is equal to total capacity of edges into sink.
